...
export default function WhatsAppButton({ locale = "en" }: { locale?: "en" | "ar" }) {
  ...
  return (
    <a
      ...
      className="group fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#1FA855] text-white shadow-card-hover ring-1 ring-white/25 transition-transform duration-300 ease-smooth hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-canvas lg:bottom-7 lg:right-7"
    >
