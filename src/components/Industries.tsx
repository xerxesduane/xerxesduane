    ...
    <section className="py-20 sm:py-28">
      <div className="container-bl">
        <SectionHeading
          ...
          subtitle="I work best with small, owner-led businesses, where the founder still picks up the phone, and good tech can quietly change everything. Each card shows what was delivered in that sector."
        />
