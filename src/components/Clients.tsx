                ...
                <div className="flex shrink-0 items-center gap-2">
                  {c.facebook && (
                    <a
                      ...
                      className="flex h-9 w-9 items-center justify-center rounded-full border border-cream/10 text-cream-dim transition-colors hover:border-gold/50 hover:text-gold"
                    >
                      <FacebookIcon />
                    </a>
                  )}
