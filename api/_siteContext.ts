...
const ROUTES: Route[] = [
  ...
  {
    path: "/insights/website-cost-dubai",
    keywords: ["cost", "costs", "price", "prices", "pricing", "budget", "quote", "much", "expensive", "cheap", "rate", "rates", "fee", "website", "web"],
  },
  {
    path: "/insights/how-much-does-odoo-cost-dubai",
    keywords: ["cost", "costs", "price", "prices", "pricing", "budget", "quote", "much", "expensive", "licence", "license", "odoo", "erp", "seat", "seats", "users"],
  },
  {
    path: "/insights/what-a-systems-audit-covers",
    keywords: ["audit", "free", "consultation", "meeting", "call", "session", "expect", "start", "started", "starting", "begin", "first", "process", "onboarding"],
  },
  {
